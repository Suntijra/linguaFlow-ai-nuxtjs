<template>
  <div class="space-y-8 max-w-5xl mx-auto">
    <div class="flex items-center justify-between">
      <h1 class="text-3xl font-extrabold text-foreground tracking-tight">AI Document Translation</h1>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-border p-6 sm:p-8">
      ...
      >
        ...
        <p class="text-sm text-muted-foreground max-w-md mx-auto">
          Supported formats: .docx, .doc. Max file size: 50MB.
          <br/> AI will preserve the original formatting of your document.
        </p>
      </div>
      ...
      <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">Speak In (Source Language)</label>
          <div class="relative">
      ...
      <div class="mt-8">
        ...
        <p v-if="showFileError" class="mt-2 text-sm text-red-500 text-center">Please upload a document first.</p>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-border overflow-hidden">
      <div class="p-6 border-b border-border">
        <h3 class="text-lg font-bold text-foreground">Recent Documents</h3>
      </div>
      <div class="p-6">
        <div class="space-y-4">
            ...
            <div class="flex items-center gap-4 w-full">
              ...
              <div class="flex-1">
                <div class="flex justify-between items-center mb-1">
                  ...
                  <span v-if="newDocState === 'loading'" class="text-xs font-medium text-primary">Translating... {{ docProgress }}%</span>
            ...
            <div class="flex items-center gap-4 w-full">
              ...
              <div class="flex-1">
                <div class="flex justify-between items-center mb-1">
                  ...
                  <span class="text-xs font-medium text-primary">Translating... 45%</span>
                </div>
        ...
        <div v-if="showOverlay" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 text-center">
            ...
            <div v-if="overlayStep === 'loading'" class="flex flex-col items-center">
              ...
              <h3 class="text-xl font-bold text-foreground mb-2">Uploading Document...</h3>
              <p class="text-muted-foreground text-sm">Analyzing your file and preparing translation.</p>
            </div>
            ...
            <div v-if="overlayStep === 'payment' && isLoggedIn" class="flex flex-col items-center">
              ...
              <div class="w-full bg-gray-50 rounded-xl p-4 border border-gray-100 text-left mb-6">
                ...
                <p class="text-xs text-muted-foreground mt-1">50 Credits • Enterprise AI Translation</p>
              </div>
            ...
            <div v-if="overlayStep === 'payment' && !isLoggedIn" class="flex flex-col items-center">
              ...
              <div v-if="guestPayMethod === 'qr'" class="flex flex-col items-center w-full">
                ...
                <p class="text-sm text-muted-foreground mb-4">Scan with any banking app to pay <strong>฿150.00</strong></p>
              ...
              <div v-if="guestPayMethod === 'card'" class="flex flex-col w-full gap-3">
                ...
                <button @click="confirmPayment" class="w-full py-3 bg-primary text-white font-bold rounded-xl hover:bg-primary/90 transition-all shadow-lg shadow-primary/20 mt-1">Pay ฿150.00</button>
            ...
            <div v-if="overlayStep === 'success'" class="flex flex-col items-center">
              ...
              <p class="text-muted-foreground text-sm mb-6">Your document translation is in progress.</p>
